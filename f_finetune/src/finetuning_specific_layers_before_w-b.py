...
def main(argv: List[str] | None = None) -> None:
    ...
    logging.info("Bucket histogram (in loaded set): %s", dict(bucket_counter))
    ...
    ds_config = args.deepspeed_config if args.use_deepspeed else None
