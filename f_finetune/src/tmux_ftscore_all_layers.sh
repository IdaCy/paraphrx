...
ANSW_DIR="f_finetune/outputs/alpaca/all_layers/inference_results"
OUT_DIR="f_finetune/outputs/alpaca/all_layers/ft_inf_scores"
IN_NAME="buckets_1-1"
...
echo "$TS - tmux_ftscore_all_layers finished $IN_NAME"
