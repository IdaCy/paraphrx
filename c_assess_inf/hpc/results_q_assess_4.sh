...
# chmod +x c_assess_inf/hpc/results_q_assess_4.sh
#
...
#
#   # run all 11 types
#   caffeinate -dimsu ./c_assess_inf/hpc/results_q_assess_4.sh
#
#   # run only specific types
#   caffeinate -dimsu ./c_assess_inf/hpc/results_q_assess_4.sh length
...
export GOOGLE_API_KEY="AIzaSyBXXuGjVs-oCv4HQ7eVDKMnUYC-j1Fk8ME"
