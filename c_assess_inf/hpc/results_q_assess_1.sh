...
# chmod +x c_assess_inf/hpc/results_q_assess_1.sh
#
...
#
#   # run all 11 types
#   caffeinate -dimsu ./c_assess_inf/hpc/results_q_assess_1.sh
#
#   # run only specific types
#   caffeinate -dimsu ./c_assess_inf/hpc/results_q_assess_1.sh boundary context style syntax
...
for TYPE in "${TYPES[@]}"; do
  ...
  LOG_FILE="$LOG_DIR/q1__${TYPE}-${TS}.txt"
